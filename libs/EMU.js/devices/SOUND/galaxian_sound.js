...
export default class GalaxianSound {
	snd = new Uint8Array(window.atob('9/n6+/z9/f7+/v39/Pv6+ff19PPy8fHw8PDx8fLz9PX39/j4+fn6+vv7/Pz9/f7+//8AAAEBAgIDAwQEBQUGBg==').split('').map(c => c.charCodeAt(0)));
	rate;
	gain;
	output = 0;
	mute = false;
	...
	samples ={
		// generic [Galaxian, ect...]
		BOMB:     new Int16Array(new Uint8Array(window.atob('\
		...
		SHOT:     new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE0001: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE0010: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE0011: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE0100: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE0101: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE0110: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE0111: new Int16Array(new Uint8Array(window.atob('\
		...
		Ffvt+sD7Gfzn+w==\
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1000: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1001: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1010: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1011: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1100: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1101: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1110: new Int16Array(new Uint8Array(window.atob('\
		...
		').split('').map(c => c.charCodeAt(0))).buffer),
		WAVE1111: new Int16Array(new Uint8Array(window.atob('\
