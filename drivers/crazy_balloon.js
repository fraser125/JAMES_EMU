...
const RomSetInfo = [
	...
	{
		// Mame name  'crbaloon'
		display_name: 'Crazy Balloon (set 1)',
		...
		romsets: [
			{
				archive_name: 'crbaloon',
				mappings: [
				{
					name: 'PRG',
					roms: ['cl01.bin','cl02.bin','cl03.bin','cl04.bin','cl05.bin','cl06.bin'],
				},
				{
					name: 'BG',
					roms: ['cl07.bin'],
	...
	{
		// Mame name  'crbaloon2'
		display_name: 'Crazy Balloon (set 2)',
		developer: 'Taito Corporation',
		year: '1980',
		Notes: '',
		...
		romsets: [
			{
				...
				{
					name: 'PRG',
					roms: ['cl01.bin','crazybal.ep2','crazybal.ep3','cl04.bin','cl05.bin','crazybal.ep6'],
				},
				{
					name: 'BG',
					roms: ['cl07.bin'],
