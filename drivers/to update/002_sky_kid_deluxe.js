...
//			this.cpu.memorymap[0x88 + i].write = (addr) => { this.bgbank = addr >> 10 & 1; };
		...
		convertGFX(this.obj, OBJ, 128, rseq(16, 2048, 64).concat(rseq(16, 0, 64)), seq(16, 0, 4).concat(seq(16, 1024, 4)), seq(4), 512);
	...
	updateStatus() {
		...
		if (this.fDIPSwitchChanged) {
			...
			case '30000 90000':
				sw.b &= ~0x30;
				break;
			case '30000 Every 90000':
				sw.b = sw.b & ~0x30 | 0x10;
				break;
			case '20000 80000':
				sw.b = sw.b & ~0x30 | 0x20;
				break;
			case '20000 Every 80000':
				sw.b |= 0x30;
				break;
			}
			if (!this.fTest)
...
import {ROM} from "../roms/sky_kid_deluxe.png.js";
