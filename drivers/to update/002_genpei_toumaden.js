...
class GenpeiToumaDen {
	...
	bg1 = new Uint8Array(0x40000).fill(3);
	bg2 = new Uint8Array(0x20000).fill(3);
	obj = new Uint8Array(0x200000).fill(15);
	...
	constructor() {
		...
		//SETUP VIDEO
		convertGFX(this.bg1, BG1, 4096, rseq(8, 0, 8), seq(8), [Math.floor(BG1.length / 3) * 16, -1, -1], 8);
		convertGFX(this.bg1, BG1, 4096, rseq(8, 0, 16), seq(4).concat(seq(4, 8)), [0, 4], 16);
		...
		convertGFX(this.obj, OBJ, 2048, rseq(16, 2048, 64).concat(rseq(16, 0, 64)), seq(16, 0, 4).concat(seq(16, 1024, 4)), seq(4), 512);
...
import {ROM} from "../roms/genpei_toumaden.png.js";
